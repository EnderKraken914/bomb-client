...
Bomb Client uses a Feather-style dark launcher shell with a top Play/Mods/Visuals/Servers nav, a profile card button, settings button, and custom minimize/maximize/exit controls. The top-right icon cluster keeps consistent spacing as the window stretches.
